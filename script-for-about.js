...
cursed.onclick = function() {
    ...
    pfp.classList.toggle('cursed')
    var audio = document.getElementById("audio");
    audio.play();
    var txt = document.getElementById('text')
    txt.textContent = 'اسمي أريت نصيردينوف ، عمري 17 عامًا. ولدت في مدينة بيشكيك. حاليًا أنا طالب ثانٍ في كلية ألا توو. أنا أدرس لغات البرمجة والخوارزميات. إذا كنت مهتمًا ، فانقر فوق الروابط الموجودة على شريط التنقل'
